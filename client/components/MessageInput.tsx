  ...
  return (
    <div className="relative">
      ...
      <form onSubmit={handleSubmit} className="relative">
        <div className="flex items-center gap-3 p-3 bg-slate-800/70 backdrop-blur-lg border border-slate-600/50 rounded-2xl shadow-xl hover:border-slate-500/50 transition-all duration-300">
          ...
          <div className="flex-1 relative">
            <textarea
              ...
              className="w-full bg-transparent text-white placeholder-slate-400 text-sm resize-none border-none outline-none pr-24 py-3 min-h-[44px] max-h-[120px] leading-relaxed scrollbar-hide"
              rows={1}
              disabled={loading}
              style={{
                scrollbarWidth: 'none',
          ...
          <button
            ...
            className={`flex items-center justify-center p-3 rounded-2xl transition-all duration-300 shadow-lg min-h-[44px] min-w-[44px] ${
